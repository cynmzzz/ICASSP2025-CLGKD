...
class ResNet_Auxiliary(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10, zero_init_residual=False):
        ...
        self.auxiliary_classifier = Auxiliary_Classifier(block, num_blocks, num_classes=num_classes, zero_init_residual=zero_init_residual)
