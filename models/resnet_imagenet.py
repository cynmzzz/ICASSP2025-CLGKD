...
if __name__ == '__main__':
    ...
    print(cal_param_size(net.backbone)/ 1e6)
    print(cal_param_size(net.auxiliary_classifier.block_extractor1)/ 1e6)
    print(cal_param_size(net.auxiliary_classifier.block_extractor2)/ 1e6)
    print(cal_param_size(net.auxiliary_classifier.block_extractor3)/ 1e6)
    print(cal_param_size(net.auxiliary_classifier.block_extractor4)/ 1e6)
